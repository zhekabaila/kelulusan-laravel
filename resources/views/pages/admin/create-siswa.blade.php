            ...
            <div class="grid grid-cols-1 gap-6 mt-14">
                ...
                <div>
                    ...
                    <select name="jurusan" id="jurusan" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" required>
                        ...
                        <option value="IPS" {{ old('jurusan') === 'IPA' ? 'selected' : ''}}>IPS</option>
                    </select>
                    @error('jurusan') <p class="text-base text-heart mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <p class="text-sm font-bold text-secondary mb-2">Rombel :</p>
                    <input type="text" name="kelas" id="kelas" value="{{ old('kelas') }}" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" placeholder="IPA-1" required>
        ...
        <div class="mt-8">
            <div class="grid grid-cols-2 gap-6 mt-14">
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai1') }}" name="nilai1" id="nilai1" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai2') }}" name="nilai2" id="nilai2" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai3') }}" name="nilai3" id="nilai3" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai4') }}" name="nilai4" id="nilai4" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai5') }}" name="nilai5" id="nilai5" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai6') }}" name="nilai6" id="nilai6" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai7') }}" name="nilai7" id="nilai7" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai8') }}" name="nilai8" id="nilai8" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai9') }}" name="nilai9" id="nilai9" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai10') }}" name="nilai10" id="nilai10" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai11') }}" name="nilai11" id="nilai11" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai12') }}" name="nilai12" id="nilai12" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai13') }}" name="nilai13" id="nilai13" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai14') }}" name="nilai14" id="nilai14" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai15') }}" name="nilai15" id="nilai15" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
                ...
                <div>
                    ...
                    <input type="text" value="{{ old('nilai16') }}" name="nilai16" id="nilai16" maxlength="255" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
