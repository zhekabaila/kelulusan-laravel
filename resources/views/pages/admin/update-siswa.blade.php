        ...
        <div class="mt-8">
            <div class="grid grid-cols-1 gap-6 mt-14">
                ...
                <div>
                    ...
                    <input type="text" name="jurusan" id="jurusan" value="{{ $data->jurusan }}" class="bg-mist p-4 rounded-[10px] outline outline-1 outline-secondary focus:bg-white focus:outline focus:outline-[3px] focus:outline-[#80BEFC] w-full text-secondary font-medium" autocomplete="off" required>
